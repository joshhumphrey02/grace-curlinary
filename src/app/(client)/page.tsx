			...
			<div>
				<div className="flex">
					<h1
						...
						className="text-4xl self-start sm:text-[5rem] font-roboto font-extrabold leading-[2.5rem] sm:leading-[5rem] flex flex-col gap-1 bg-clip-text text text-transparent">
